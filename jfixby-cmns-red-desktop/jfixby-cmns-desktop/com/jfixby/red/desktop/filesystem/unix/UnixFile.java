...
public class UnixFile extends AbstractRedFile implements File {

	final private AbsolutePath<FileSystem> absolute_path;
	private final UnixFileSystem fs;
	private final String absolute_path_string;

	public UnixFile (final AbsolutePath<FileSystem> output_file_path, final UnixFileSystem windowsFileSystem) {
	...
	public boolean rename (final String new_name) {
		final java.io.File f = new java.io.File(this.getAbsoluteWindowsPathString());
		final UnixFile new_file = new UnixFile(this.absolute_path.parent().child(new_name), this.fs);
	...
	public boolean equals (final Object obj) {
		...
		final UnixFile other = (UnixFile)obj;
