...
public class WinFile extends AbstractRedFile implements File {

	final private AbsolutePath<FileSystem> absolute_path;
	private final WinFileSystem fs;
	private final String absolute_path_string;

	public WinFile (final AbsolutePath<FileSystem> output_file_path, final WinFileSystem windowsFileSystem) {
	...
	public boolean rename (final String new_name) {
		final java.io.File f = new java.io.File(this.getAbsoluteWindowsPathString());
		final WinFile new_file = new WinFile(this.absolute_path.parent().child(new_name), this.fs);
	...
	@Override
	public WinFileSystem getFileSystem () {
		return this.fs;
	}
	...
	public boolean equals (final Object obj) {
		...
		final WinFile other = (WinFile)obj;
