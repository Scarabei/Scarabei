...
public final class RedLocalFile extends AbstractRedFile implements LocalFile {

	AbsolutePath<FileSystem> absolute_path;
	private final RedLocalFileSystem fs;
	...
	public RedLocalFile (final AbsolutePath<FileSystem> absolute_path, final RedLocalFileSystem fileSystem) {
	...
	@Override
	final public RedLocalFileSystem getFileSystem () {
		return this.fs;
	}
