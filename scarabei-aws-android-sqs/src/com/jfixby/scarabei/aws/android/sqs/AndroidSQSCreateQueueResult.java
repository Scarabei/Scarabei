...
public class AndroidSQSCreateQueueResult implements SQSCreateQueueResult {

	private final CreateQueueResult aws_createQueueResult;
	private final String url;

	public AndroidSQSCreateQueueResult (final SQSCreateQueueParams createQueueRequestParams, final AmazonSQSClient awsSQSClient) {
