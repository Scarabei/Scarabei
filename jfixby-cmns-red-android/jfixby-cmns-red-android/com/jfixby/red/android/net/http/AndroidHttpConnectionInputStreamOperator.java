...
public class AndroidHttpConnectionInputStreamOperator implements JavaInputStreamOperator {

	private InputStream java_input_stream;
	private final URLConnection java_connection;

	public AndroidHttpConnectionInputStreamOperator (final URLConnection java_connection) {
