...
public class RedStringValueID implements StringValueID {
	...
	public int hashCode() {
		...
		result = prime
				* result
				+ ((string_value_id_string == null) ? 0
						: string_value_id_string.hashCode());
		return result;
	}
	...
	public boolean equals(Object obj) {
		...
		if (string_value_id_string == null) {
			if (other.string_value_id_string != null)
				return false;
		} else if (!string_value_id_string.equals(other.string_value_id_string))
			return false;
		return true;
	}
