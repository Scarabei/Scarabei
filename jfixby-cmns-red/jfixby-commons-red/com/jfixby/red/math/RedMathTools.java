...
public class RedMathTools implements MathToolsComponent {
	...
	public boolean pointLiesInsideTriangle (double point_x, double point_y, double triangle_x0, double triangle_y0,
		...
		double A = area(triangle_x0, triangle_y0, triangle_x1, triangle_y1, triangle_x2, triangle_y2);

		/* Calculate area of triangle PBC */
		double A1 = area(point_x, point_y, triangle_x2, triangle_y2, triangle_x1, triangle_y1);

		/* Calculate area of triangle PAC */
		double A2 = area(triangle_x1, triangle_y1, point_x, point_y, triangle_x0, triangle_y0);

		/* Calculate area of triangle PAB */
		double A3 = area(triangle_x0, triangle_y0, triangle_x2, triangle_y2, point_x, point_y);
	...
	public void setupOffsetMatrix (Matrix matrix, double... offset) {
		...
		if (matrix.getHeight() != 1 + offset.length) {
			...
			throw new Error("Matrix dimentions are incompatible with the offset vector: " + "" + doubles);
		}
