...
class S3File extends AbstractRedFile implements File {
	...
	private final AndroidS3FileSystem fs;
	private final RelativePath relative;
// private S3ObjectInfo objectInfo;

	public S3File (final AbsolutePath<FileSystem> output_file_path, final AndroidS3FileSystem file_system) {
	...
	public static String toNativePathString (final String string) {
		return string.replaceAll(RelativePath.SEPARATOR, AndroidS3FileSystem.OS_SEPARATOR + AndroidS3FileSystem.OS_SEPARATOR);
	}
...
// }
	...
	@Override
	public AndroidS3FileSystem getFileSystem () {
		return this.fs;
	}
