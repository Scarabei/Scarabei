...
public class AndroidSQSClient implements SQSClient {

	private AmazonSQSClient awsSQSClient;

	public AndroidSQSClient (final SQSClienSpecs params) {
	...
	public SQSReceiveMessageResult receive (final SQSReceiveMessageRequest request) {
		return new AndroidSQSReceiveMessageRequestResult((AndroidSQSReceiveMessageRequest)request, this.awsSQSClient);
	}

	@Override
	public SQSCreateQueueResult createQueue (final SQSCreateQueueParams createQueueRequestParams) {
		return new AndroidSQSCreateQueueResult(createQueueRequestParams, this.awsSQSClient);
	}
	...
	public SQSSendMessageResult sendMessage (final SQSSendMessageParams sendParams) {
		...
		return new AndroidSQSSendMessageResult(result);
	}
	...
	public SQSDeleteMessageResult deleteMessage (final SQSDeleteMessageParams delete) {
		...
		return new AndroidSQSDeleteMessageResult();
	}
